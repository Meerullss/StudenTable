...
import com.fyp.StudenTable.activity.MainActivity;
import com.fyp.StudenTable.R;

import java.util.Calendar;


public class CurrentDay extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        NotificationCompat.Builder mNotifyBuilder = new NotificationCompat.Builder(
                context, "").setSmallIcon(R.mipmap.studentable_round)
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.mipmap.studentable))
    ...
    private String getLessons(int day) {
        ...
        db.getWeek(currentDay).forEach(week -> {
            if(week != null) {
                lessons.append(week.getModule()).append(" ")
