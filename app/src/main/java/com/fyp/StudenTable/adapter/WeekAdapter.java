...
public class WeekAdapter extends ArrayAdapter<Week> {
    ...
    public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
        String module = Objects.requireNonNull(getItem(position)).getModule();
        ...
        week = new Week(module, teacher, room, time_from, time_to, color);
        ...
        if(convertView == null){
            ...
            holder.module = convertView.findViewById(R.id.module);
        ...
        holder.module.setText(week.getModule());
        holder.lecturer.setText(week.getLecturer());
                ...
                public boolean onMenuItemClick(MenuItem item) {
                    switch (item.getItemId()) {
                        ...
                        case R.id.edit_popup:
                            final View alertLayout = mActivity.getLayoutInflater().inflate(R.layout.dialog_module, null);
                            SetupDialog.getEditSubjectDialog(mActivity, alertLayout, weeklist, mListView, position);
                            notifyDataSetChanged();
                            return true;
                        default:
