...
public class ExamAdapter extends ArrayAdapter<Exam> {
    ...
    public ExamAdapter(Activity activity, ListView listView, int resource, ArrayList<Exam> objects) {
    ...
    public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
        ...
        String teacher = Objects.requireNonNull(getItem(position)).getLecturer();
        ...
        if (convertView == null) {
            ...
            holder.module = convertView.findViewById(R.id.moduleexams);
            holder.lecturer = convertView.findViewById(R.id.lecturerexams);
        ...
        holder.module.setText(exam.getModule());
        holder.lecturer.setText(exam.getLecturer());
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            ...
                            case R.id.edit_popup:
                                final View alertLayout = mActivity.getLayoutInflater().inflate(R.layout.dialog_exam, null);
                                SetupDialog.getEditExamDialog(mActivity, alertLayout, examlist, mListView, position);
                                notifyDataSetChanged();
                                return true;
                            default:
